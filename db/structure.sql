...
--
-- Name: flow_paths_mv_flow_id_column_position_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX flow_paths_mv_flow_id_column_position_idx ON public.flow_paths_mv USING btree (flow_id, column_position);
